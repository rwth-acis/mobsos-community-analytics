...
set_in_service_config db.user_las2peermon ${db.user_las2peermon}
set_in_service_config db.dbSchema_las2peer ${db.dbSchema_las2peer}
set_in_service_config db.dbType_las2peermon ${db.dbType_las2peermon}

set_in_service_config db.dbType_las2peer ${db.dbType_las2peer}
set_in_service_config db.user_las2peer  ${db.user_las2peer}
set_in_service_config db.password_las2peer ${db.password_las2peer}

set_in_service_config db.url_las2peermon ${db.url_las2peermon}
set_in_service_config junit ${junit}
set_in_service_config db.password_las2peermon ${db.password_las2peermon}
set_in_service_config db.dbSchema_las2peermon ${db.dbSchema_las2peermon}
