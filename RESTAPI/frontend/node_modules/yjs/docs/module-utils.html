...
<dl>
        ...
        <dt>
            <h4 class="name">
                <a href="module-utils.YEvent.html">YEvent</a>
                <div class="container-source members">
                    <code><a href="module-utils.YEvent.html">module:utils.YEvent</a></code>
                </div>
            </h4>
        </dt>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'module:utils_sub'.replace(/"/g, '_');
