...
<head>
    <meta charset="utf-8">
    <title>Class: QuillBinding | yjs</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>
            <span class="ancestors"><a href="module-bindings_quill.html">bindings/quill</a>.</span>QuillBinding<span class="signature">(textType, quill)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>A Binding that binds a YText type to a Quill editor.</p></div>
...
<dt>
        ...
        <h4 class="name" id="QuillBinding">
            
                new <span class="type-signature"></span>QuillBinding<span class="signature">(textType, quill)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="bindings_quill.js.html">bindings/quill.js</a></code>,
                <code><a href="bindings_quill.js.html#line35">line 35</a></code>
            </div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>textType</code></td>
...
<span class="param-type">YText</span>
        ...
        <tr>
                ...
                <td class="name"><code>quill</code></td>
            

            <td class="type">
            
                
<span class="param-type">Quill</span>
...
<dl class="details">
    ...
    <pre class="prettyprint"><code>const quill = new Quill(document.createElement('div'))
...
<h4 class="name" id="target">
    <span class="type-signature"></span>target<span class="type-signature"> :Quill</span>
    
    <div class="container-source members">
        <code><a href="bindings_quill.js.html">bindings/quill.js</a></code>,
        <code><a href="bindings_quill.js.html#line51">line 51</a></code>
    </div>
...
<h4 class="name" id="type">
    <span class="type-signature"></span>type<span class="type-signature"> :YText</span>
    
    <div class="container-source members">
        <code><a href="bindings_quill.js.html">bindings/quill.js</a></code>,
        <code><a href="bindings_quill.js.html#line46">line 46</a></code>
    </div>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'module:bindings/quill.QuillBinding_sub'.replace(/"/g, '_');
