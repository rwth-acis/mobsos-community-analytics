...
<head>
    <meta charset="utf-8">
    <title>Tutorial: ProseMirror Binding | yjs</title>
...
<section>
    <header>
        ...
        <article>
            ...
            <iframe id="example-result" width="100%" height="800" frameborder="0" src=tutorials/prosemirror.html></iframe>
            <div id="example-js" class="hidden"><pre class="prettyprint source">
...
window.example = { provider, ydocument, type, prosemirrorView }
            ...
            <div id="example-html" class="hidden"><pre class="prettyprint source">
