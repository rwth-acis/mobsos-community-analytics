...
<head>
    <meta charset="utf-8">
    <title>Module: structs | yjs</title>
...
<dl>
        ...
        <dt>
            <h4 class="name">
                <a href="module-structs.Type.html">Type</a>
                <div class="container-source members">
                    <code><a href="module-structs.Type.html">module:structs.Type</a></code>
                </div>
            </h4>
        </dt>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'module:structs_sub'.replace(/"/g, '_');
