...
<head>
    <meta charset="utf-8">
    <title>Class: WebsocketProvider | yjs</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>
            <span class="ancestors"><a href="module-provider_websocket.html">provider/websocket</a>.</span>WebsocketProvider<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>Websocket Provider for Yjs. Creates a single websocket connection to each document.
The document name is attached to the provided url. I.e. the following example
creates a websocket connection to http://localhost:1234/my-document-name</p></div>
...
<dt>
        ...
        <h4 class="name" id="WebsocketProvider">
            
                new <span class="type-signature"></span>WebsocketProvider<span class="signature">()</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="provider_websocket_WebSocketProvider.js.html">provider/websocket/WebSocketProvider.js</a></code>,
                <code><a href="provider_websocket_WebSocketProvider.js.html#line157">line 157</a></code>
            </div>
...
<dl class="details">
    ...
    <pre class="prettyprint"><code>import { WebsocketProvider } from 'yjs/provider/websocket/client.js'
  const provider = new WebsocketProvider('http://localhost:1234')
  const ydocument = provider.get('my-document-name')</code></pre>
...
<h4 class="name" id="docs">
    <span class="type-signature"></span>docs<span class="type-signature"> :Map.&lt;string, WebsocketsSharedDocument></span>
    
    <div class="container-source members">
        <code><a href="provider_websocket_WebSocketProvider.js.html">provider/websocket/WebSocketProvider.js</a></code>,
        <code><a href="provider_websocket_WebSocketProvider.js.html#line167">line 167</a></code>
    </div>
...
<span class="param-type">Map.&lt;string, WebsocketsSharedDocument></span>
...
<dt>
        ...
        <h4 class="name" id="get">
                ...
                <span class="type-signature"></span>get<span class="signature">(name)</span><span class="type-signature"> &rarr; {WebsocketsSharedDocument}</span>
                
            
            <div class="container-source members">
                <code><a href="provider_websocket_WebSocketProvider.js.html">provider/websocket/WebSocketProvider.js</a></code>,
                <code><a href="provider_websocket_WebSocketProvider.js.html#line173">line 173</a></code>
            </div>
...
<span class="param-type">WebsocketsSharedDocument</span>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'module:provider/websocket.WebsocketProvider_sub'.replace(/"/g, '_');
