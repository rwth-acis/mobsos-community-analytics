...
public class MediabaseTestAPITest {
	...
	public void testGetEntry() {
		...
		try {
			...
			//Assert.assertEquals("[{\"perma_link\":\"http://headspicket.de/2008/04/wie-viele-t-shirts/\"}]",result.getResponse().trim());
	...
	public void testPutEntry() {
		...
		try {
			...
			String json = "{\"AUTHORNAME\":\"Test Testing\", \"AUTHORURL\":\"www.test.de\"}";
	...
	public void testDeleteEntry() {
		try {
			...
			client.setConnectorEndpoint(connector.getHttpEndpoint());
			client.setLogin(testAgent.getIdentifier(), testPass);
			String pathing = "data/DB2INFO5/BW_AUTHOR?condition=ID=3";
			pathing = "data/DB2INFO5/BW_AUTHOR";
	...
	public void testDbConnection() {
		...
		Connection connection = MediabaseTestAPI.dbConnection(filePath);
		...
		connection = MediabaseTestAPI.dbConnection(filePath);
	...
	public void testGetAutoGenerated() {
		...
		List<String> actual = MediabaseTestAPI.getAutoGenerated(connection, "DB2INFO5", "BW_AUTHOR");
		...
		actual = MediabaseTestAPI.getAutoGenerated(connection, "FAILURE", "NOTHING_HERE");
