...
function callRequestConstruction() {
	if (document.getElementById("DatabaseSelect").value == "All") {
		if (document.getElementById("TemplateType").value == "Media-User") {
			var query = "query{all_reviews(id:\"" +  document.getElementById("userInput").value + "\"){date, mood}}";
		...
		if (document.getElementById("TemplateType").value == "Media-User") {
			if (document.getElementById("DatabaseSelect").value == "las2peer") {
				var query = "query{" + document.getElementById("DatabaseSelect").value + "_reviewentry(id:\"" + 
				document.getElementById("userInput").value + "\"){author_id, mood}}";
				query = "query{" + document.getElementById("DatabaseSelect").value + "_reviewentry{author_id, mood}}";
			} else {
