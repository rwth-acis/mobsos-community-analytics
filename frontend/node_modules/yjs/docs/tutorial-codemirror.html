...
<head>
    <meta charset="utf-8">
    <title>Tutorial: CodeMirror Binding | yjs</title>
...
<section>
    <header>
        ...
        <article>
            ...
            <iframe id="example-result" width="100%" height="800" frameborder="0" src=tutorials/codemirror.html></iframe>
