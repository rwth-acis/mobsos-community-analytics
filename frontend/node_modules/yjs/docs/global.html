...
<dt>
<h4 class="name" id="encodable">
    encodable
    
    <div class="container-source members">
        <code><a href="utils_Y.js.html">utils/Y.js</a></code>,
        <code><a href="utils_Y.js.html#line14">line 14</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Anything that can be encoded with <code>JSON.stringify</code> and can be decoded with
<code>JSON.parse</code>.</p>
<p>The following property should hold:
<code>JSON.parse(JSON.stringify(key))===key</code></p>
<p>At the moment the only safe values are number and string.</p>
    </div>
