...
<head>
    <meta charset="utf-8">
    <title>Class: DomBinding | yjs</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>
            <span class="ancestors"><a href="module-bindings_dom.html">bindings/dom</a>.</span>DomBinding<span class="signature">(type, target, opts<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>A binding that binds the children of a YXmlFragment to a DOM element.</p>
<p>This binding is automatically destroyed when its parent is deleted.</p></div>
...
<dt>
        ...
        <h4 class="name" id="DomBinding">
            
                new <span class="type-signature"></span>DomBinding<span class="signature">(type, target, opts<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="bindings_dom_DomBinding.js.html">bindings/dom/DomBinding.js</a></code>,
                <code><a href="bindings_dom_DomBinding.js.html#line35">line 35</a></code>
            </div>
...
<span class="param-type">YXmlFragment</span>
            ...
            <td class="description last"><p>The bind source. This is the ultimate source of
                           truth.</p></td>
        </tr>
...
<span class="param-type">Element</span>
            ...
            <td class="description last"><p>The bind target. Mirrors the target.</p></td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>Optional configurations</p>
                <h6>Properties</h6>
...
<span class="param-type">DomFilter</span>
            ...
            <td class="description last"><p>The filter function to use.</p></td>
        </tr>
...
<span class="param-type">Object</span>
        ...
        <tr>
                ...
                <td class="name"><code>scrollingElement</code></td>
...
<dl class="details">
    ...
    <pre class="prettyprint"><code>const div = document.createElement('div')
...
<dt>
<h4 class="name" id="domToType">
    <span class="type-signature"></span>domToType<span class="type-signature"> :Map</span>
    
    <div class="container-source members">
        <code><a href="bindings_dom_DomBinding.js.html">bindings/dom/DomBinding.js</a></code>,
        <code><a href="bindings_dom_DomBinding.js.html#line71">line 71</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Maps each DOM element to the type that it is associated with.</p>
    </div>
...
<h4 class="name" id="filter">
    <span class="type-signature"></span>filter<span class="type-signature"> :DomFilter</span>
    
    <div class="container-source members">
        <code><a href="bindings_dom_DomBinding.js.html">bindings/dom/DomBinding.js</a></code>,
        <code><a href="bindings_dom_DomBinding.js.html#line82">line 82</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Defines which DOM attributes and elements to filter out.
...
<h4 class="name" id="target">
    <span class="type-signature"></span>target<span class="type-signature"> :Element</span>
    
    <div class="container-source members">
        <code><a href="bindings_dom_DomBinding.js.html">bindings/dom/DomBinding.js</a></code>,
        <code><a href="bindings_dom_DomBinding.js.html#line58">line 58</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>The target that <code>type</code> is bound to.</p>
    </div>
...
<h4 class="name" id="type">
    <span class="type-signature"></span>type<span class="type-signature"> :YXmlFragment</span>
    
    <div class="container-source members">
        <code><a href="bindings_dom_DomBinding.js.html">bindings/dom/DomBinding.js</a></code>,
        <code><a href="bindings_dom_DomBinding.js.html#line53">line 53</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>The Yjs type that is bound to <code>target</code></p>
    </div>
...
<dt>
<h4 class="name" id="typeToDom">
    <span class="type-signature"></span>typeToDom<span class="type-signature"> :Map</span>
    
    <div class="container-source members">
        <code><a href="bindings_dom_DomBinding.js.html">bindings/dom/DomBinding.js</a></code>,
        <code><a href="bindings_dom_DomBinding.js.html#line76">line 76</a></code>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>Maps each YXml type to the DOM element that it is associated with.</p>
    </div>
...
<dt>
        ...
        <h4 class="name" id="destroy">
            ...
            <div class="container-source members">
                <code><a href="bindings_dom_DomBinding.js.html">bindings/dom/DomBinding.js</a></code>,
                <code><a href="bindings_dom_DomBinding.js.html#line224">line 224</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>Remove all properties that are handled by this class.</p>
    </div>
...
<dt>
        ...
        <h4 class="name" id="setFilter">
            
                <span class="type-signature"></span>setFilter<span class="signature">(filter)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="bindings_dom_DomBinding.js.html">bindings/dom/DomBinding.js</a></code>,
                <code><a href="bindings_dom_DomBinding.js.html#line160">line 160</a></code>
            </div>
...
<dd>
    ...
    <div class="description">
        <p>NOTE:</p>
<ul>
<li>does not apply filter to existing elements!</li>
<li>only guarantees that changes are filtered locally. Remote sites may see different content.</li>
</ul>
    </div>
...
<span class="param-type">DomFilter</span>
            ...
            <td class="description last"><p>The filter function to use from now on.</p></td>
        </tr>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'module:bindings/dom.DomBinding_sub'.replace(/"/g, '_');
