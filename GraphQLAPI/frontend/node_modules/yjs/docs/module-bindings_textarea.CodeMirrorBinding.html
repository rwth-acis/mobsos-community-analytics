...
<head>
    <meta charset="utf-8">
    <title>Class: CodeMirrorBinding | yjs</title>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>
            <span class="ancestors"><a href="module-bindings_textarea.html">bindings/textarea</a>.</span>CodeMirrorBinding<span class="signature">(textType, codeMirror, options<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>A binding that binds a YText to a CodeMirror editor.</p></div>
...
<dt>
        ...
        <h4 class="name" id="CodeMirrorBinding">
            
                new <span class="type-signature"></span>CodeMirrorBinding<span class="signature">(textType, codeMirror, options<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="bindings_codemirror.js.html">bindings/codemirror.js</a></code>,
                <code><a href="bindings_codemirror.js.html#line132">line 132</a></code>
            </div>
...
<span class="param-type">YText</span>
        ...
        <tr>
                ...
                <td class="name"><code>codeMirror</code></td>
...
<dl class="details">
    ...
    <pre class="prettyprint"><code>const ytext = ydocument.define('codemirror', Y.Text)
  const editor = new CodeMirror(document.querySelector('#container'), {
    mode: 'javascript',
    lineNumbers: true
  })
  const binding = new CodeMirrorBinding(editor)</code></pre>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'module:bindings/textarea.CodeMirrorBinding_sub'.replace(/"/g, '_');
