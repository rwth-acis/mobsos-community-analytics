...
<head>
    <meta charset="utf-8">
    <title>Module: provider/websocket | yjs</title>
...
<dl>
        ...
        <dt>
            <h4 class="name">
                <a href="module-provider_websocket.WebsocketProvider.html">WebsocketProvider</a>
                <div class="container-source members">
                    <code><a href="module-provider_websocket.WebsocketProvider.html">module:provider/websocket.WebsocketProvider</a></code>
                </div>
            </h4>
        </dt>
...
<dt>
        ...
        <h4 class="name" id="~permissionDeniedHandler">
            
                <span class="type-signature"><span class="icon green">inner</span> </span>permissionDeniedHandler<span class="signature">(doc, reason)</span><span class="type-signature"></span>
                
            
            <div class="container-source members">
                <code><a href="provider_websocket_WebSocketProvider.js.html">provider/websocket/WebSocketProvider.js</a></code>,
                <code><a href="provider_websocket_WebSocketProvider.js.html#line24">line 24</a></code>
            </div>
...
<dt>
        ...
        <h4 class="name" id="~readMessage">
                ...
                <span class="type-signature"><span class="icon green">inner</span> </span>readMessage<span class="signature">(doc, buf)</span><span class="type-signature"> &rarr; {Y.encoding.Encoder}</span>
                
            
            <div class="container-source members">
                <code><a href="provider_websocket_WebSocketProvider.js.html">provider/websocket/WebSocketProvider.js</a></code>,
                <code><a href="provider_websocket_WebSocketProvider.js.html#line31">line 31</a></code>
            </div>
...
<span class="param-type">Y.encoding.Encoder</span>
...
<script src="scripts/linenumber.js"></script>
    ...
    <script>
        var id = 'module:provider/websocket_sub'.replace(/"/g, '_');
